...
function render() {
    for (let index = 0; index < products.length; index++) {
        table.innerHTML += tableHTML(index);
        3
        total = total.parse(products[index].price)
    }
    table.innerHTML += `
    <tr>
    <th scope="col"></th>
    ...
    <th>
        <form id="formAdd">
            <button type="submit" id="btnBuy" class="btn btn-success">
                Buy
            </button>
        </form>
    </th>
...
$(document).ready(function() {
    $("#formAdd").submit(function(e) {
        ...
        swal({
            position: 'center',
            type: 'success',
            title: 'Purchese made successfully',
            text: `Your purchese order is: ${total*total*23}`,
